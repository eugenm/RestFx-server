package com.example.restfx.server.controller;

import com.example.restfx.common.WelcomeMessage;
...
public class WelcomeController {
     ...
     * to the server at the sub-url of '/welcome' (e.g. http://localhost:8080/RestFx-server/welcome)
